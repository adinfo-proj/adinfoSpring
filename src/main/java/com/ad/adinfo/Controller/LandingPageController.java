...
import com.ad.adinfo.Domain.LANDING_PAGE;
...
public class LandingPageController {
            ...
            @RequestPart (value = "dataObj"                 ) Map<String, Object> params) throws Exception
    {
        ...
        LANDING_PAGE tbLandingPage = new LANDING_PAGE();
        ...
        tbLandingPage.setPgId(Long.parseLong(params.get("pgId").toString()));
            ...
            //-------------------------------------------------------------------
                ...
                for(int j = 0 ; j < inputArr.size() ; j++) {
                    ...
                    if(arrGab.get("values").equals("textForm")) {
                        phpTag += "\n      <input type='text' name='value03' placeholder='" + arrGab.get("names") + "'>";
                    }
                    //-------------------------------------------------------------------
                    // 라디오 박스
                    //-------------------------------------------------------------------
                        ...
                        for(int k = 0 ; k < strArr.length; k++) {
                            phpTag += "\n          <input type='radio' name='agree01' id='" + strArr[k] + "'>";
                    ...
                    //-------------------------------------------------------------------
                        ...
                        for(int k = 0 ; k < strArr.length; k++) {
                            phpTag += "\n          <input type='checkbox' name='agree01' id='" + strArr[k] + "'>";
                            phpTag += "\n          <label for='" + strArr[k] + "'>" + strArr[k] + "</label>";
                        }
                        phpTag += "\n        </div>";
                    }
